...
provider "aws" {
  ...
  # CM-6: required compliance tags stamped on every taggable resource.
  default_tags {
    tags = {
...
# AC-3: access enforcement — explicit deny on every public-access vector.
...
# AU-3 / AU-6: audit record content + audit review (the log bucket).
